...
<head>
    ...
    <style>
        ...
        .attachments-info { background: #F3F4F6; border-radius: 6px; padding: 14px 16px; font-size: 13px; margin: 20px 0; }
        .attachments-info strong { display: block; margin-bottom: 8px; color: #1B2F4E; }
        .attachments-info ul { margin: 0; padding-left: 20px; }
        .attachments-info li { margin-bottom: 4px; color: #4B5563; }
    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="info-grid">
                ...
                @if(isset($fecVenci) && $fecVenci !== 'No definida')
                <div class="info-row">
            ...
            <div class="attachments-info">
                ...
                <ul>
                    <li>Archivo digital principal del radicado</li>
                    @if(isset($radicado) && $radicado->archivos && $radicado->archivos->count() > 0)
                        @foreach($radicado->archivos as $archivo)
                            <li>{{ $archivo->nom_origi ?? basename($archivo->archivo) }}</li>
                        @endforeach
                    @endif
                </ul>
            </div>
