...
class VentanillaRadicaReciResponsaController extends Controller
{
     ...
     * }
     */
    public function store(StoreResponsaReciboRequest $request)
    {
        try {
            DB::beginTransaction();
     ...
     * }
     */
    public function update($id, StoreResponsaReciboRequest $request)
    {
        try {
            DB::beginTransaction();
     ...
     *   }
     */
    public function assignToRadicado($radica_reci_id, StoreResponsaReciboRequest $request)
    {
        try {
            DB::beginTransaction();
