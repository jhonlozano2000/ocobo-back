...
class StoreRadicadoEnviadoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'tercero_enviado_id' => 'nullable|exists:gestion_terceros,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'tercero_id.required' => 'El destinatario es obligatorio.',
            'tercero_id.exists' => 'El destinatario no es válido.',
