...
class VentanillaRadicaEnviadosMetadata extends Model
{
    use HasFactory;

    protected $table = 'ventanilla_radica_enviados_metadata';
    ...
    {
        return $this->belongsTo(VentanillaRadicaEnviadosArchivos::class, 'archivo_id');
    }

    public function radicado(): BelongsTo
    {
        return $this->belongsTo(VentanillaRadicaEnviados::class, 'radicado_id');
    }
