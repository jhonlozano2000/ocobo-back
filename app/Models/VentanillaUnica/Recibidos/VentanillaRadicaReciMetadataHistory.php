...
class VentanillaRadicaReciMetadataHistory extends Model
{
    protected $table = 'ventanilla_radica_reci_metadata_history';
    ...
    {
        return $this->belongsTo(VentanillaRadicaReciMetadata::class, 'metadata_id');
    }
