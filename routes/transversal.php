...
use App\Http\Controllers\Transversal\FirmaMasivaController;
...
// M13 — Firma masiva de documentos
Route::middleware('auth:sanctum')->post('firma-electronica/firmar-masivo', [FirmaMasivaController::class, 'firmarMasivo']);
