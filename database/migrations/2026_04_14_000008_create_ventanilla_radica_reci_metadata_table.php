...
return new class extends Migration
{
    ...
    {
        Schema::create('ventanilla_radica_reci_metadata', function (Blueprint $table) {
            $table->id();
            
            // Relaciones
            $table->unsignedBigInteger('archivo_id')->nullable();
            $table->unsignedBigInteger('radicado_id')->nullable();
            $table->unsignedBigInteger('nivel_clasificacion_id')->nullable()->comment('FK a config_file_classification_levels');
            ...
            $table->string('tipo_archivo', 20)->default('adjunto'); // digital, adjunto
    ...
    {
        Schema::dropIfExists('ventanilla_radica_reci_metadata');
    }
};
